# Generated by Django 2.1.5 on 2019-02-01 02:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_description', models.CharField(max_length=120, verbose_name='Short description (Optional)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imdb_id', models.CharField(max_length=7, verbose_name='IMDb id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(default='', max_length=300, verbose_name='Description (Optional)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choice', models.CharField(choices=[('omg', 'I really really want to see it.'), ('yes', 'I want to see it.'), ('seenok', "I've seen it, but I wouldn't mind seeing it."), ('meh', 'Meh...'), ('no', "I don't want to see it."), ('seenno', "I've seen it, and I don't want to see it again."), ('veto', 'Veto!')], max_length=6)),
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='democracy.Club')),
                ('film', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='democracy.Film')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
